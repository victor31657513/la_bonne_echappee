...
function testWindExposureFatigue() {
  const exposed = { relayPhase: 'pull', draftFactor: 1, inRelayLine: false, inBreakaway: false, energy: 100 };
  const sheltered = { relayPhase: 'pull', draftFactor: 1.3, inRelayLine: false, inBreakaway: false, energy: 100 };
